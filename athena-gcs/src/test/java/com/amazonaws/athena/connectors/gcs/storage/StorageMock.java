...
import com.amazonaws.athena.connectors.gcs.storage.datasource.ParquetMetadata;
import com.amazonaws.athena.connectors.gcs.storage.mock.AthenaConstraints;
import com.amazonaws.athena.connectors.gcs.storage.mock.AthenaMarker;
import com.amazonaws.athena.connectors.gcs.storage.mock.AthenaReadRecordsRequest;
...
public class StorageMock
{
    ...
    public ParquetMetadata mockParquetDatasource() throws IOException
    {
        ParquetMetadata parquetDatasource = Mockito.mock(ParquetMetadata.class);
    ...
    // helpers
    public void mockStorageSplit(ParquetMetadata datasource) throws IOException
    {
